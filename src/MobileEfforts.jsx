            ...
            <div className="container">
                <div className=' bg-pattern bg-center bg-no-repeat bg-cover bg-light-blue max-w-[1210px] rounded-[22px]'>
                    <div className='py-[39px] px-[35px]'>
                        <div className=' flex items-center gap-[45px] flex-col lg:flex-row'>
                            <img src={mobile} alt="" />
                            <div>
                                <p className=' max-w-[633px] font-Messiri font-bold text-[29px] lg:text-[40px] leading-[48px] text-white'>Webserv’s efforts have increased mobile conversion rates and reduced ad spending by 61% and 20%, respectively.</p>
